      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          ...
          >
            ...
            >
              At Dwellio, we're more than just a real estate platform. We're your trusted partner in finding the perfect property that matches your dreams and aspirations. With over 15 years of experience, we've helped thousands of families find their ideal homes.
            </motion.p>
            ...
            >
              <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <p className="text-gray-600 text-sm">Carefully curated selection of premium properties</p>
              </div>

              <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                <FaHandshake className="text-4xl text-primary mb-4" />
                <h3 className="text-xl font-semibold mb-2">Expert Guidance</h3>
                <p className="text-gray-600 text-sm">Professional support throughout your journey</p>
              </div>
